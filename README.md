...
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-git/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-git/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-git.svg)](https://github.com/buluma/ansible-role-git/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-git.svg)](https://github.com/buluma/ansible-role-git/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-git.svg)](https://github.com/buluma/ansible-role-git/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/git)](https://galaxy.ansible.com/ui/standalone/roles/buluma/git/documentation)|
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-git/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-git
